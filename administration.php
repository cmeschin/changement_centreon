		...
		echo '<div id="tabs">';
			echo '<ul>';
				...
				echo '<li><a href="#tabs-2">Association des modèles</a></li>';
 				...
 				echo '<li><a href="#tabs-4">Statistiques</a></li>';
 				echo '<li><a href="#tabs-5">extraction configuration</a></li>';
 				echo '</ul>';
			echo '<div id="tabs-1">';
			...
			echo '<div id="tabs-4">';
				...
				include_once('statistiques_traitement.php');
 				include_once('statistiques_consigne.php');
				echo '<div id="accordion_stats">';
					...
					echo '<div id="suivi_consigne">';
						...
						echo '</div>';
					echo '<h3>Charge estimée par semaine</h3>';
					echo '<div id="charge_hebdomadaire">';
