...
// 	$bdd_supervision->beginTransaction();
	addlog("Chargement envoi mail finalise");
	...
	//==========
	// flaguer mail_finalise dans la table demande pour ne pas renvoyer le mail
	$maj_demande = $bdd_supervision->prepare('UPDATE demande
			 SET mail_creation=1, mail_encours=1, mail_finalise=1, mail_traite=0, mail_annule=0
...
// 	die('Erreur traitement envoi_mail_encours: '. $e->getMessage());
//};
