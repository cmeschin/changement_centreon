...
//		$message_txt = "Statut = Closed\nRéférence Ticket Client = " . htmlspecialchars($res_mail['ref_demande']) . "\n\nLa demande de supervision a été annulée pour le motif suivant:" . htmlspecialchars($res_mail['motif_annulation']) . ".\nVeuillez vous rapprocher de l'équipe Centreon pour de plus amples informations.";
		$message_txt = "La demande de supervision a été annulée pour le motif suivant:" . htmlspecialchars($res_mail['motif_annulation']) . ".\nVeuillez vous rapprocher de l'équipe Centreon pour de plus amples informations.";
	...
	addlog("mail annule envoyé");
	//==========
	// flaguer mail_annule dans la table demande pour ne pas renvoyer le mail
	$maj_demande = $bdd_supervision->prepare('UPDATE demande
			 SET mail_creation=1, mail_encours=1, mail_finalise=1, mail_traite=0, mail_annule=1
