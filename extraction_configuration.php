...
//			addlog("categorie=" . $categorie);
		...
		$values .= ",(" . $elements['host_id'] . ",'" . $elements['host_name'] . "','" . $elements['host_address'] . "'," . $elements['service_id'] . ",'" . $elements['service_description'] . "'," . $elements['service_template_id'] . ",'" . $elements['service_template_name'] . "','" . $Cat_All . "','" . $Cat_Archi . "','" . $Cat_Fonction . "','" . $Cat_Langue . "','" . $Cat_OS . "','" . $Cat_Type . "')";
		if ($i % 100 == 0)
		{
